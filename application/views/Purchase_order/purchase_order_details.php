...
<div id="page-wrapper">
       <div class="container-fluid" style="border: 1px solid black">   
            ...
            <form action="<?php echo base_url()?>index.php/Purchase_order/insertPurchaseOrder" method="post">
                <div class="form-group">
                    <label for="refno">Reference No</label>
                    <input type="text" class="form-control" name="refno" style="height: 30px">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="unitprice" style="height: 30px">
                    <?php echo form_error('unitprice');?>
                </div>
                <div class="form-group">
                    <label for="vatrate">Vat Rate</label>
                    <input type="text area" class="form-control" name="vatrate" style="height: 30px">
                ...
                <div class="col-xs-12">
                    ...
                    <input type="submit" name="insert" value="Create Purchase Order">
                </div>                
                </div>               
