...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header">Purchase Request - Assets</h3>
    </div>
    <!-- /.col-lg-12 -->
  </div>
...
<div class="row" style="height:40px"></div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-lg-4 col-lg-offset-5"><input type="submit" name="add_another" value="Add Another" class="btn btn-info" />
                        <input type="submit" name="send" value="Send" class="btn btn-info" />
                        <input type="submit" name="save_as_draft" value="Save As Draft" class="btn btn-info" /></div>
                    </div>
            </form> <!-- /form -->
