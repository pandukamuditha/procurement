<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            <li>
                <a href=""><i class="fa fa-dashboard fa-fw"></i> TEC Dashboard </a>
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="morris.html">Past Procuremets</a>
                    </li>
                </ul>
                <!-- /.nav-second-level --> 
            </li>
...
<div class="form-group">
  <form action="<?php echo base_url().'index.php/TEC/submit_review' ?>" method="POST" >
  <label class="col-md-4 control-label" for="textinput">Req ID</label>  
  <div class="col-md-4">
  <input id="textinput" name="pr_id" type="text" placeholder="For Req_id : 12<?php //echo $pr_id['pr_id']; ?>"  class="form-control input-md" disabled>
  ...
  <div class="col-md-4">
    <div class="form-group">
                        ...
                        <select name="eval_by"  style="width:auto;" class="form-control selectWidth">
                          <option class="">Mr. Kalupahana</option>
                          <option class="">Mr. Liyanathranthri</option>
                          <option class="">Mr. Samarasekara</option>
                          <option class="">Mr. Somarathna</option>
                        </select>
               </div>
    </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textarea" style="resize: none;" name="comments">Comments</label>
  <div class="col-md-4">                     
...
<div class="form-group">
  <label class="col-md-4 control-label" for="Opinion" >Ratings</label>
  <div class="col-md-4">
  <div class="radio">
    <label for="Opinion-0">
      <input type="radio" name="decision" id="Opinion-0" >
      Satisfactory
    </label>
    </div>
  <div class="radio">
    <label for="Opinion-1">
      <input type="radio" name="decision" id="Opinion-1" >
      Need reviews
    </label>
    </div>
  <div class="radio">
    <label for="Opinion-2">
      <input type="radio" name="decision" id="Opinion-2" >
      Rejected
    </label>
    </div>
  </div>
...
<div class="form-group">
  ...
  function clickAlert() {
    ...
    <button id="" name="submit" class="btn btn-success" >Submit</button>
  </form>
  </div>
</div>
